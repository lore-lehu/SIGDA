...
$sql = "SELECT id, codigo, nombre, activo, uc, DATE_FORMAT(fc,'%d/%m/%Y %H:%i') fc, um, DATE_FORMAT(fm,'%d/%m/%Y %H:%i') fm FROM archivos WHERE id = '$id'";
...
$sql_proyecto = "SELECT codigo, nombre FROM proyectos WHERE id = ".$idproyecto."";
$result_proyecto = $conn->query($sql_proyecto);
$row_proyecto = $result_proyecto->fetch_array(MYSQLI_ASSOC);
$codigo_proyecto = $row_proyecto['codigo'];
          ...
          <div class="content-wrapper">  
			  ...
			  <h3 class="titulo" style="background-color: #0F4157; color: #f1faff; padding: 10px">Proyecto: <?php echo strtoupper($nombre_proyecto." (".$codigo_proyecto.")"); ?></h3>
                        <div class="container">
                            ...
                            <h3 class="h3_titulos">Editar Archivo</h3>
                            ...
                            <form role="form" data-toggle="validator">
                              ...
                              <div class="form-group">
                                  <a class="btn_nuevo pull-left" href="<?php echo $nomtitulo; ?>_new.php?idproyecto=<?php echo $idproyecto; ?>" target="_parent">
