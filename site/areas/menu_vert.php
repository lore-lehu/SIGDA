<?php
$file_foto = '../site/files/usuarios/usuario.png';
	...
	.finmenu {
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview"><a href="#"><i class="fa fa-wrench"></i><span>Mantenimientos</span><i class="fa fa-angle-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="../site/proyectos.php"><i class="fa fa-address-card"></i> Proyectos</a></li> 
                <li><a href="../site/usuarios.php"><i class="fa fa-address-card"></i> Usuarios</a></li> 
              </ul>
            </li>
